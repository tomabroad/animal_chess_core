...
public class BoardTest {
  ...
  @Test
  public void testValidateMove() throws NoSuchMethodException, SecurityException, IllegalAccessException,
      IllegalArgumentException, InvocationTargetException {
    Board board = new Board();

    ValidationCase[] onboardCases = {
        // valid
        new ValidationCase(2, 1, 1, 1, true), new ValidationCase(3, 1, 2, 2, true),
        // from: outside, no piece
        new ValidationCase(4, 1, 1, 1, false), new ValidationCase(2, 0, 1, 1, false),
        // to: outside, attacking ally, out of range
        new ValidationCase(2, 1, 4, 1, false), new ValidationCase(3, 0, 2, 1, false),
